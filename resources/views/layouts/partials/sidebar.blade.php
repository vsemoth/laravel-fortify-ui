...
<aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: 100%;">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ url('/admin/dashboard') }}"><i class='fa fa-link'></i> <span>{{ trans('adminlte_lang::message.home') }}</span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('kidsparties.index') }}">Posts Management</a></li>
